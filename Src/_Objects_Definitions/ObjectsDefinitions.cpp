...
ParameterInt  par2      ( 101,                  // _id        - Идентификатор параметра. Для привязки к FRAM
          ...
          par4      ( 103,                  // _id        - Идентификатор параметра. Для привязки к FRAM
                      ...
                      1,                  // _user      - Доступ в режиме пользователя
                      21),                 // _def       - Значение по умолчанию
uDcBusCalibratingVoltage( 104,            // _id        - Идентификатор параметра. Для привязки к FRAM
...
ParameterFlt  pwmDeathTime( 200,                    // _id        - Идентификатор параметра. Для привязки к FRAM
              ...
              pwmValue( 201,                        // _id        - Идентификатор параметра. Для привязки к FRAM
                      ...
                      -2),                // _power     - Степень
                uDcBus( 202,                        // _id        - Идентификатор параметра. Для привязки к FRAM
                      ...
                      100,                // _def       - Значение по умолчанию
                      0),                 // _power     - Степень
               uDcBusCalibrationZero( 203,                        // _id        - Идентификатор параметра. Для привязки к FRAM
                      (char *)"B.4",              // _menu      - Идентификатор меню.
                      (char *)"Калибровочный коэффициент нуля датчика напряжения на шине",   //_text      - Тестовая информация
                      255,                // _modbusAdr	- Адрес модбас
                      321,                // _value     - Значение параметра
                      1,                  // _rw        - Разрешение на запись
                      0,                  // _min       - Минимальное значение
                      ...
                      100,                // _def       - Значение по умолчанию
                      0),                 // _power     - Степень
               uChargeCalibrationZero( 204,                        // _id        - Идентификатор параметра. Для привязки к FRAM
                      (char *)"B.5",              // _menu      - Идентификатор меню.
                      (char *)"Калибровочный коэффициент нуля датчика напряжения заряда",   //_text      - Тестовая информация
                      255,                // _modbusAdr	- Адрес модбас
                      321,                // _value     - Значение параметра
                      1,                  // _rw        - Разрешение на запись
                      0,                  // _min       - Минимальное значение
                      ...
                      100,                // _def       - Значение по умолчанию
                      0),                 // _power     - Степень
               iChargeCalibrationZero( 205,                        // _id        - Идентификатор параметра. Для привязки к FRAM
                      (char *)"B.6",              // _menu      - Идентификатор меню.
                      (char *)"Калибровочный коэффициент нуля датчика тока заряда",   //_text      - Тестовая информация
                      255,                // _modbusAdr	- Адрес модбас
                      321,                // _value     - Значение параметра
                      1,                  // _rw        - Разрешение на запись
                      0,                  // _min       - Минимальное значение
...
DecoratorFltCalibrated  uDcBusCalibrationCoeff (900,
                      (char *)"G.0",              // _menu      - Идентификатор меню.
                      (char *)"Калибровочный коэффициент датчика напряжения на шине",   //_text      - Тестовая информация
                      255,                // _modbusAdr	- Адрес модбас
                      ...
                      uChargeCalibrationCoeff (901,
                      (char *)"G.1",              // _menu      - Идентификатор меню.
                      (char *)"Калибровочный коэффициент датчика напряжения заряда",   //_text      - Тестовая информация
                      255,                // _modbusAdr	- Адрес модбас
                      102,                // _value     - Значение параметра
                      1,                  // _rw        - Разрешение на запись
                      0,                  // _min       - Минимальное значение
                      ...
                      iChargeCalibrationCoeff (902,
                      (char *)"G.2",              // _menu      - Идентификатор меню.
                        (char *)"Калибровочный коэффициент датчика тока заряда",   //_text      - Тестовая информация
                      255,                // _modbusAdr	- Адрес модбас
                      102,                // _value     - Значение параметра
                      1,                  // _rw        - Разрешение на запись
                      0,                  // _min       - Минимальное значение
...
//---------------------------------------------------------------------------------------------------------
  ...
  AnalogRmsSensor uDcSensor(60e-6, 0.1, 60e-6, 0.01, &uDcBusCalibrationCoeff, &uDcBusCalibrationZero);
  AnalogRmsSensor uChargeSensor(60e-6, 0.1, 60e-6, 0.01, &uChargeCalibrationCoeff, &uChargeCalibrationZero);
  AnalogRmsSensor iChargeSensor(20e-6, 0.1, 20e-6, 0.001,&iChargeCalibrationCoeff, &iChargeCalibrationZero);
