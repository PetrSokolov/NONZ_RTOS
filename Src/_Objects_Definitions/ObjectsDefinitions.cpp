...
ParameterFlt  pwmDeathTime( 200,                    // _id        - Идентификатор параметра. Для привязки к FRAM
              ...
              pwmValue( 201,                        // _id        - Идентификатор параметра. Для привязки к FRAM
                ...
                uDcBus( 202,                        // _id        - Идентификатор параметра. Для привязки к FRAM
                      ...
                      100,                // _def       - Значение по умолчанию
                      0),                 // _power     - Степень
/*               vUCalibrating( 203,                        // _id        - Идентификатор параметра. Для привязки к FRAM
                      (char *)"B.4",              // _menu      - Идентификатор меню.
                      (char *)"Напряжение калибровочное",   //_text      - Тестовая информация
                      255,                // _modbusAdr	- Адрес модбас
                      321,                // _value     - Значение параметра
                      1,                  // _rw        - Разрешение на запись
                      0,                  // _min       - Минимальное значение
                      ...
                      100,                // _def       - Значение по умолчанию
                      0),                 // _power     - Степень*/
               vICalibrating( 204,                        // _id        - Идентификатор параметра. Для привязки к FRAM
...
//---------------------------------------------------------------------------------------------------------
  ...
  AnalogDcRmsSensor uDcSensor(60e-6, 0.1,&vUDcBusCodeUCal, &vUDcBusCodeZero, &vUCalibrating);
  AnalogDcRmsSensor uChargeSensor(60e-6, 0.1, &vUChargeCodeUCal, &vUChargeCodeZero, &vUCalibrating);
  AnalogDcRmsSensor iChargeSensor(20e-6, 0.1, &vIChargeCodeUCal, &vIChargeCodeZero, &vICalibrating);
